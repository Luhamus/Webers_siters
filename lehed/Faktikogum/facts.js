var factPlaceholder = document.getElementById("hold-fact");
var showFact = document.getElementById("show-fact");



var UselessFacts = ["Most American car horns honk in the key of F.",
...
function randomFact(){
  return UselessFacts[factNumber];
}

showFact.addEventListener('click', function(){
  factNumber = Math.floor(Math.random()*UselessFacts.length);
